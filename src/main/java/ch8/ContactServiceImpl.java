...
public class ContactServiceImpl implements ContactService {
    ...
    public Contact findById(Long id) {
        ...
        return (Contact) em.createNamedQuery("Contact.findById",Contact.class).setParameter("id",id).getSingleResult();
    ...
    public Contact save(Contact contact) {
        ...
        if(contact.getId()==null){
            ...
            em.merge(contact);
            LOG.info("Update existing contact");
        }
    ...
    public void delete(Contact contact) {
        ...
        LOG.info("Removed contact :"+contact.getId());
    }

    public static final String ALL_CONTACT_NATIVE_QUERY = "select id, first_name, last_name, birth_date, version from contact";
    ...
    public List<Contact> findByCriteriaQuery(String firstName, String lastName) {
        LOG.info("Finding contact for "+firstName+" "+lastName);
